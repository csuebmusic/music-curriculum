...
[currency.md](currency.md) records what in each stored document is superseded and when each was last checked. Read it before relying on the guide.

Outcomes, course characteristics, and course caps come from the framework. Routing, forms, and the path a proposal takes after a GEOC vote come from the guide.

## documents

- [GE Framework starting Fall 2027](ge-framework-fall-2027.pdf): the learning outcomes, course characteristics, and course caps for every GE, Overlay, and Code area, plus the GEOC course review, assessment, and recertification policies. This is what the alignment form asks you to copy from.
