...
Standing reference for CLASS Curriculum Committee review, kept alongside the proposals it applies to.

## documents

- [GEOC faculty guide](geoc-faculty-guide-2024.pdf), revised July 2024, the edition posted on the GEOC for Faculty page: approval steps and timeline, the recertification cycle, which Curriculog form matches which action, the problems that most often delay proposals, and the GE, Overlay, and Code learning outcomes and course characteristics in Appendix I. Appendix II sorts course revisions into action items for CIC, information items for CIC, and items that stop at the GEOC Subcommittee.
...
- [GE Framework starting Fall 2027](https://www.csueastbay.edu/ge/files/docs/ge-framework-documents/ge-framework-starting-fall-2027.pdf): the learning outcomes and course characteristics to copy into the alignment form, with the revised outcomes that start in Fall 2026.
...
- [Checklist for Faculty](https://docs.google.com/document/d/1WzDjn8g_cbvUSN5CaCgvwDghS5YBbE9LxeZWZ3CAHGo/edit), maintained by GEOC.
- [Curricular Procedures Manual](https://www.csueastbay.edu/aps/academic-programs/curriculum-development-new/cpm/index.html).

## contacts

Jennifer Zenovich is Director of General Education and chair of the GEOC Subcommittee, which meets the second and fourth Wednesday of each month from 2 to 4 PM by Zoom. Curriculog questions go to catalog@csueastbay.edu.
