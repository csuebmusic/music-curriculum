...
add("ba-2-application-received", "ba", "Application Received",
  ...
  UL([
    ...
    "<strong>Send your transcripts.</strong> Ask each school you&rsquo;ve attended (high school, community college, or any other 4-year college) to send them electronically to " + TRANSCRIPTS + ". You will not receive an admission offer until we have them. " + A(U["trans"], "How to submit documents") + ".",
